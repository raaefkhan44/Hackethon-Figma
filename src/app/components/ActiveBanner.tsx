...
import ActivitySection from "../../../public/activebanner.png";
    ...
    <div className="relative">
      ...
      <div className="relative z-10 flex flex-col-reverse md:flex-row justify-end items-center px-5 py-16 md:px-12 md:py-12">
        ...
        <div className="md:w-1/2 text-left text-white">
          <h3 className="text-2xl font-semibold text-[#FF9F0D]">Restaurant Active Process</h3>
        ...
        >
          ...
          {/* Video Player */}
          <video ref={videoRef} className="w-4/5 md:w-3/4 max-w-4xl z-10" src="/resvideo.mp4" controls />
