...
import BlogDetailsPage from "@/app/components/BlogD";
...
const BlogDetails = () => {
  ...
  return (
    <>
      <MainBreadcum name="Blog Details" pageName="Blog details" />
      <div className="relative">

        {/* Toggle Button for Sidebar */}
        <button
          className="fixed bottom-54 right-4 z-50 bg-orange-500 p-2 rounded-full text-white shadow-lg xl:hidden"
        ...
        <div className="w-[80%] max-lg:w-[95%] py-20 flex flex-col lg:flex-row justify-between m-auto relative">
          ...
          {/* Sidebar */}
          <div
            className={`sidebar w-full ml-5 lg:w-[424px] bg-white p-4 border border-gray-200 space-y-16 mt-10 lg:mt-0 fixed xl:static top-0 ${
