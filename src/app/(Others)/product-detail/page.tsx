        ...
        <div className="flex flex-wrap lg:flex-nowrap">
            ...
            <div className="flex flex-col gap-4 ">
              {["/sd-1.png", "/sd-2.png", "/sd-3.png", "/sd-4.png"].map((image, index) => (
                <button
                  ...
                  className={`border ${selectedImage === image ? "border-[#FF9F0D]" : "border-gray-300"
                    } rounded-lg`}
                >
                  <Image src={image} width={400} height={400} alt="Thumbnail" className="w-24 h-20 rounded-lg" />
                </button>
              ))}
            </div>
          ...
          <div className="lg:w-2/3 lg:pl-10 mt-6 lg:mt-0">
            ...
            <div className="mt-4 flex items-center space-x-4">
              <span className="flex items-center text-[#FF9F0D] space-x-1">
                ⭐⭐⭐⭐⭐
              </span>
